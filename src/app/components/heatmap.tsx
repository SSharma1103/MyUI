...
import type { HeatmapData, HeatmapGridProps } from '@/types';
...
interface HeatmapGridComponentProps extends HeatmapGridProps {
    className?: string;
}

export const HeatmapGrid: FC<HeatmapGridComponentProps> = ({ data, className }) => {
    ...
    return (
        <div className={cn("inline-flex flex-col gap-2 p-4 bg-slate-900/50 border border-slate-800 rounded-lg", className)}>
