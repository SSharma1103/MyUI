      ...
      <div className="relative">
        <div
          className="flex flex-col rounded-xl border border-slate-700 bg-slate-800/50 p-2
                     focus-within:ring-2 focus-within:ring-sky-500 transition-all duration-300"
        >
          <div className="flex w-full items-start">
            <textarea
              ...
              rows={1}
              className="w-full max-h-48 resize-none bg-transparent px-2 pt-2
                         text-slate-200 placeholder-slate-400 outline-none"
            />

            <button
              type="submit"
              disabled={!value.trim()}
              className="ml-2 mt-0.5 flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg
                         bg-sky-500 transition-colors hover:bg-sky-600 disabled:cursor-not-allowed
...
export const CommandInputPreview2 = () => (
