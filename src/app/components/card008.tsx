...
interface NeoCodeSnippetProps extends React.HTMLAttributes<HTMLDivElement> {
  initialCode?: string;
}

const NeoCodeSnippet: FC<NeoCodeSnippetProps> = ({
  ...
  return (
    <div className={cn("w-full max-w-2xl border-4 border-black shadow-[8px_8px_0_#000]", className)} {...props}>
