...
import type { ExperienceCardProps, CheckpointProps, ExperienceItem } from '@/types';
...
interface ScrollTimelineProps extends React.HTMLAttributes<HTMLElement> {
  title?: string;
...
export const ScrollTimeline = ({
  ...
  return (
    <section ref={targetRef} className={cn("relative h-[200vh] w-full", className)} {...props}>
      <div className="sticky top-0 h-screen flex flex-col items-center justify-center p-4 md:p-16">
        <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 md:mb-16 text-center">{title}</h2>
