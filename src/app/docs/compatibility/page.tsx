  ...
  return (
    <div className="text-white">
      ...
      <p className="text-lg text-slate-400 mb-8">
        MyUI Library is designed to work seamlessly across modern web platforms.
        Here’s a detailed breakdown of our compatibility targets and support
        levels.
      </p>
      ...
      <div className="space-y-12">
        <InfoSection title="Browser Support">
          <p>
            We support the latest stable versions of all major browsers. We do
            not support Internet Explorer 11. Our components rely on modern CSS
            features like Flexbox and Grid, which are well-supported in the
            browsers listed below.
          </p>
          <ul className="space-y-3">
            <CompatibilityItem
              name="Google Chrome (v127+)"
              status="Supported"
            />
            <CompatibilityItem
              name="Mozilla Firefox (v128+)"
              status="Supported"
            />
            <CompatibilityItem
              name="Microsoft Edge (v127+)"
              status="Supported"
            />
        ...
        <InfoSection title="Framework Versions">
          <p>
            Our library is built on top of specific versions of Next.js and
            React. While it may work with older versions, we only guarantee full
            functionality and support for the following:
          </p>
          <ul className="space-y-3">
            <CompatibilityItem
          ...
          <p className="text-sm text-slate-400 mt-4">
            <strong>Note on Pages Router:</strong> While most components are
            compatible, some hooks optimized for the App Router (like
            `usePathname`) may need to be replaced with equivalents from
            `next/router`.
          </p>
        </InfoSection>
        ...
        <InfoSection title="Styling Engine">
          <p>
            The styling is deeply integrated with Tailwind CSS. Using this
            library without Tailwind is not a supported use case.
          </p>
          <ul className="space-y-3">
